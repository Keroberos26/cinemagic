                                        ...
                                        <div class="card-body">
                                            <form action="/my-account" method="post" class="row g-4" enctype="multipart/form-data">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example" id="city" name="sltCity" data-city="${acc.city}">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example" id="district" name="sltDistrict" data-district="${acc.district}">
                                                        <option selected disabled value="">Chọn khu vực</option>
                                                    </select>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example" id="ward" name="sltWard" data-ward="${acc.ward}">
                                                        <option selected disabled value="">Chọn khu vực</option>
                                                    </select>
                                                </div>
